...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/axis2-spring-boot-starter)](https://github.com/easy-4-java/axis2-spring-boot-starter)
...
> **Artifact ID**：`axis2-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**axis2-spring-boot-starter** is a Spring Boot starter that integrates **axis2** for applications using axis2. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume axis2 capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using axis2 |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for axis2 |
| JDK | `17` |
| Coordinates | `io.github.easy4j:axis2-spring-boot-starter:4.0.x.20260527-SNAPSHOT` |
| Config Prefix | `axis2` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers axis2 beans automatically |
| Property Binding | ✅ Stable | Binds `axis2.*` to `Axis2Properties` |
| `ConfigurationContext` bean | ✅ Stable | Auto-registered via Axis2AutoConfiguration |
...
|---|---|---|:---:|---|:---:|
| `axis2.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl axis2-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `axis2.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/axis2-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/axis2-spring-boot-starter)
